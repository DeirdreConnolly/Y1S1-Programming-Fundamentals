...
while True:
    try:
        ...
        if not managerName.isalpha():
            print("Invalid input. Try again.")
            continue

        managerEmail = input("Email address: ")
        if not managerEmail.isalpha():
            print("Invalid input. Try again.")
            continue

        managerPhone = input("Phone number: ")
        if not managerPhone.isnumeric():
            print("Invalid input. Try again.")
            continue

        dateStart = input("Start date (dd/mm/yyyy): ")
        if not dateStart.isnumeric():
            print("Invalid input. Try again.")
            continue

        bandName = input("Band name: ")
        if not bandName.isalnum():
            print("Invalid input. Try again.")
            continue
